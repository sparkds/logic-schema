...
package sparkDS.testData

import org.apache.spark.rdd.RDD
import org.apache.spark.sql.{Row, SaveMode}
import org.apache.spark.sql.types._
import org.scalatest._
import sparkDS.testUtil.SparkTestUtil

class GenerateParquetFilesTest extends FlatSpec with Matchers {

  "========================================================================================================================" +
    "\nCase 1 - Generate sales parquet file" should "return true" in {
    val orderFileSchema: StructType = DataTypes.createStructType(List(
    ...
    val orderDF = SparkTestUtil.spark.createDataFrame(orderFileData, orderFileSchema)
...
//    orderDF.write.mode(SaveMode.Overwrite).parquet(TestDataFile.salesFilePath)
  }
